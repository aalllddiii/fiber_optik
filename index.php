...
?>
                            ...
                            <br>
                            <label><caption><?php echo $kelas; ?></caption> </label><br>
                            <input type="text" class="form-control" name="kelas" required>
                            <br><caption><?php echo $domisili; ?></caption>
                            ...
                            <label> <caption><?php echo $kontak; ?></caption> </label><br>
