...
$sdd = mysqli_query($con, " SELECT * FROM `data_mhs`");
								...
								?>
									...
									<tr>
										...
										<td>
											...
											<a href="../delete.php?id=<?= $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('Apakah kamu yakin ingin menghapus data ini? Data yang telah dihapus tidak dapat dikembalikan.')">Hapus</button></a>
