...
<body id="page-top">
  ...
  <div id="sukses" class="overlay">
    <div class="popup">
      ...
      <div class="content">
          <?php 
          $lulus = mysqli_query($conn, "SELECT * FROM kelulusan WHERE username='{$_SESSION['username']}'");
          ?>
          <?php
          while ($out = mysqli_fetch_array($lulus)) { ?>
        Kamu diterima di kepanitiaan <?php echo $out['acara']; ?><br>
        Divisi <?php echo $out['divisi']; ?>
        <?php } ?>
      </div>
    </div>
  </div>
